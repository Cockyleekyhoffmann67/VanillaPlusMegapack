...
All CowboyBingus Helldivers 2 gameplay mods in one install. Better stratagem placement, hellpod steering, reinforcement placement, vaulting, shallow-water diving, sentry aim retention, synchronized enemy corpse collision, and controllable hover-pack descent.

**Requires the separately built Bingus Shared Loader v11 or newer.** Install two ZIPs: `Vanilla-Plus-Megapack-v6.zip` and `Bingus-Shared-Loader-v11.zip`. Mod managers do not install the dependency automatically.

[Download v6](https://github.com/CowboyBingus/VanillaPlusMegapack/releases/tag/v6). Download [Bingus Shared Loader](https://github.com/CowboyBingus/BingusSharedLoader/releases/latest) from its own repository.

## Install with Arsenal or HD2MM

1. Close Helldivers 2. Use one mod manager.
2. Replace any previous loader entry with v11 or newer. You can leave current standalone gameplay packages installed.
3. Import `Vanilla-Plus-Megapack-v6.zip` and `Bingus-Shared-Loader-v11.zip`, then enable both.
