...
**Requires the separately built Bingus Shared Loader v9 or newer.** Install two ZIPs: `Vanilla-Plus-Megapack-v4.zip` and `Bingus-Shared-Loader-v9.zip`. Mod managers do not install the dependency automatically.

[Download v4](https://github.com/CowboyBingus/VanillaPlusMegapack/releases/tag/v4). Download [Bingus Shared Loader](https://github.com/CowboyBingus/BingusSharedLoader/releases/latest) from its own repository.
...
3. Import `Vanilla-Plus-Megapack-v4.zip` and `Bingus-Shared-Loader-v9.zip`, then enable both.
