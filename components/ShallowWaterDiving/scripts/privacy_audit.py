...
SOURCE_FILES = (
    ...
    'docs/PRIVACY.md', 'docs/RELEASE_NOTES.md', 'docs/TECHNICAL.md',
...
def audit(package=None, staged=False):
    entries, findings = [], []
    ...
    report = {'source_files':entries, 'zip_entries':zip_entries, 'git_index_verified':staged, 'findings':findings,
...
if __name__ == '__main__':
    ...
    args = parser.parse_args();audit(args.zip, args.staged)
