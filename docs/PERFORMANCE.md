...
| Scene | v2.6 mean ms/poll | v2.7 mean ms/poll | v2.7 p95 ms/poll | Reads/poll before to after |
| --- | ---: | ---: | ---: | ---: |
| Empty managers | 0.025 | 0.032 | 0.135 | 13 to 9 |
| 256 living enemies | 2.660 | 0.385 | 0.578 | 1,294 to 266 |
| 1,500 living enemies | 19.910 | 0.377 | 0.547 | 7,514 to 266 |
| 32 ragdolls + 32 corpses | 229.945 | 1.533 | 2.285 | 45,042 to 206 |
| 500 living + 48 ragdolls + 48 corpses | 240.802 | 1.513 | 2.137 | 46,717 to 233 |
