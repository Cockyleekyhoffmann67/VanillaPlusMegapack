# Rows alternative for v14

`Vanilla-Plus-Megapack-Rows-v14.zip` is a complete alternate megapack. It uses
...
matches the standard v14 ZIP byte for byte. Enemy Collision Synchronized v2.9
...
For a source build, build or download the standard v14 ZIP into the release
