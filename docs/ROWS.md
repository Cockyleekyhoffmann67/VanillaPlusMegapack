# Rows alternative for v13

`Vanilla-Plus-Megapack-Rows-v13.zip` is a complete alternate megapack. It uses
...
Every other resource, including the pack identity and all nine other mods,
matches the standard v13 ZIP byte for byte. Enemy Collision Synchronized v2.9
...
The same eleven independent mod options are available in Arsenal and HD2MM.
...
For a source build, build or download the standard v13 ZIP into the release
