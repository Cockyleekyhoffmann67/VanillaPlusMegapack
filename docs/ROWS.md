# Rows alternative for v17

`Vanilla-Plus-Megapack-Rows-v17.zip` is a complete alternate megapack. It uses
...
matches the standard v17 ZIP byte for byte. Enemy Collision Synchronized v2.9
...
For a source build, build or download the standard v17 ZIP into the release
