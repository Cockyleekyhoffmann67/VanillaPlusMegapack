# Rows alternative for v18

`Vanilla-Plus-Megapack-Rows-v18.zip` is a complete alternate megapack. It uses
...
matches the standard v18 ZIP byte for byte. Enemy Collision Synchronized v2.9
...
For a source build, build or download the standard v18 ZIP into the release
