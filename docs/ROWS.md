# Rows alternative for v15

`Vanilla-Plus-Megapack-Rows-v15.zip` is a complete alternate megapack. It uses
...
matches the standard v15 ZIP byte for byte. Enemy Collision Synchronized v2.9
...
For a source build, build or download the standard v15 ZIP into the release
