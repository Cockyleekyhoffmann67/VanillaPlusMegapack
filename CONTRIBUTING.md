...
```powershell
node tests/test_arsenal.cjs ../releases/Vanilla-Plus-Megapack-v10.zip D:/fixtures/arsenal build/arsenal-options
dotnet run --project tests/hd2mm/Harness.csproj -c Release -- D:/fixtures/hd2mm ../releases/Vanilla-Plus-Megapack-v10.zip build/hd2mm-options
```
