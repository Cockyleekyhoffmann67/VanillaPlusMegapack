...
The normal build runs all 25 upstream gameplay/interoperability test processes and package checks. Those tests use synthetic data in the test process. They do not test live gameplay.

To test the actual compiled loader with the pack, first build Bingus Shared Loader v11, then run:
